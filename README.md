...
## Модель (Weights)
Файл весов модели `efficientnet_merged.pth` исключен из репозитория.

1. **Скачайте модель**: [Google Drive Download](https://drive.google.com/uc?export=download&id=1GaBZKCR4TTZ-C4sq8WmrKzEsPSTDfhO0)
2. **Установка**: Поместите файл в папку `models/` в корне проекта.
